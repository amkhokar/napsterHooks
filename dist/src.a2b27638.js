...
function App() {
  var napsterAPI = "https://api.napster.com/v2.2/tracks/top?apikey=ZTk2YjY4MjMtMDAzYy00MTg4LWE2MjYtZDIzNjJmMmM0YTdm";
  var allSongs = useEndpoint({
    method: "GET",
    url: napsterAPI
  });
  return _react.default.createElement("div", null, _react.default.createElement("h1", null, "Napster API Songs"), _react.default.createElement("div", null, _react.default.createElement("ul", null, allSongs.pending && 'Loading...' || allSongs.complete && allSongs.data.tracks.map(function (track, id) {
    return _react.default.createElement("li", {
      key: id
    }, "Name: ", _react.default.createElement("b", null, track.name), _react.default.createElement("br", null), "Artist:", _react.default.createElement("b", null, track.artistName), _react.default.createElement("br", null), _react.default.createElement("audio", {
